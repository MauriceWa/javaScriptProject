"use strict";
(self.webpackChunkangular_client = self.webpackChunkangular_client || []).push([[7568], {
    57568: (ne,O,c)=>{
        c.r(O);
        var v = c(63942)
            , a = c(15861)
        ...
        function E(e) {
            ...
            "number" == typeof e && isFinite(e) || !0 === e || !1 === e || "[object String]" === Object.prototype.toString.call(e))
                return e;
        ...
        function p(e) {
            ...
            return Array.isArray(e) ? e.map(t=>p(t)) : "function" == typeof e || "object" == typeof e ? k(e, t=>p(t)) : e
        }
        const N = "functions"
            , C = {
            OK: "ok",
        ...
        function L(e, t) {
            ...
            try {
                ...
                if (s) {
                    ...
                    if ("string" == typeof o) {
                        if (!C[o])
                            return new d("internal","internal");
                        n = C[o],
                            r = o
                    }
                    const u = s.message;
        ...
        class U {
            constructor(t, n, r) {
                ...
                this.auth || t.get().then(i=>this.auth = i, ()=>{}
                ),
            ...
            getAuthToken() {
                ...
                return (0,
                    ...
                    if (t.auth)
                        try {
                            return (yield t.auth.getToken())?.accessToken
                        } catch {
                            return
                        }
                })()
            ...
            getMessagingToken() {
                ...
                return (0,
                    a.Z)(function*() {
                    if (t.messaging && "Notification"in self && "granted" === Notification.permission)
                        try {
        ...
        class M {
            ...
            _url(t) {
                ...
                return null !== this.emulatorOrigin ? `${this.emulatorOrigin}/${n}/${this.region}/${t}` : null !== this.customDomain ? `${this.customDomain}/${t}` : `https://${this.region}-${n}.cloudfunctions.net/${t}`
            }
        }
        function H(e, t, n, r) {
        ...
        function T() {
            return (T = (0,
                ...
                const h = $(r.timeout || 7e4)
                    , f = yield Promise.race([H(t, i, s, e.fetchImpl), h.promise, e.cancelAllRequests]);
                if (h.cancel(),
                    !f)
                    throw new d("cancelled","Firebase Functions instance was deleted.");
                const S = L(f.status, f.json);
                if (S)
                    throw S;
                if (!f.json)
                    throw new d("internal","Response is not valid JSON object.");
                let m = f.json.data;
                if (typeof m > "u" && (m = f.json.result),
                typeof m > "u")
        ...
        !function j(e, t) {
            (0,
                g._registerComponent)(new I.wA(N,(r,{instanceIdentifier: i})=>{
                ...
                (0,
                    g.registerVersion)(x, P, t),
                (0,
                    g.registerVersion)(x, P, "esm2017")
        }(fetch.bind(self));
        class D {
            constructor(t, n) {
                this.app = t,
            ...
            useFunctionsEmulator(t) {
                const n = t.match("[a-zA-Z]+://([a-zA-Z0-9.-]+)(?::([0-9]+))?");
                if (null == n)
                    throw new l.ZR("functions","No origin provided to useFunctionsEmulator()");
                if (null == n[2])
                    throw new l.ZR("functions","Port missing in origin provided to useFunctionsEmulator()");
                return y(this._delegate, n[1], Number(n[2]))
            }
            useEmulator(t, n) {
                return y(this._delegate, t, n)
            }
        }
        const ee = (e,{instanceIdentifier: t})=>{
                const n = e.getProvider("app-compat").getImmediate()
                    , r = e.getProvider("functions").getImmediate({
                    identifier: t ?? "us-central1"
                });
                return new D(n,r)
            }
        ;
        (function te() {
                ...
                v.Z.INTERNAL.registerComponent(new I.wA("functions-compat",ee,"PUBLIC").setServiceProps(e).setMultipleInstances(!0))
            }
        )(),
            v.Z.registerVersion("@firebase/functions-compat", "0.2.7")
    }
}]);
